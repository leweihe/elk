			...
			this.jTree.addTreeSelectionListener(new TreeSelectionListener() {
				public void valueChanged(TreeSelectionEvent e) {
					...
					if (node.getUserObject() == "版本宣告") {
						...
						Help.this.jTextPane.setText("2.41a版正在研制中……");
					} else if (node.getUserObject() == "作者说明") {
						Help.this.jLabel.setText("作者说明");
						Help.this.jTextPane.setText("作者:核辐射\n飞Q:192.168.2.166");
					} else {
						Help.this.jLabel.setText("国旗说明");
						Help.this.jTextPane.setText("了解各国国旗的含义");
						if (node.getUserObject() == "中国") {
							Help.this.jLabel.setText("中国");
							Help.this.jLabel.setIcon(new ImageIcon(getClass().getResource("/flags/China-Flag.png")));
							Help.this.jTextPane.setText(
							...
							Help.this.jLabel.setText("阿根廷");
							Help.this.jLabel.setIcon(new ImageIcon(getClass().getResource("/flags/1.png")));
							Help.this.jTextPane.setText(" ");
						} else if (node.getUserObject() == "巴西") {
							Help.this.jLabel.setText("巴西");
							Help.this.jLabel.setIcon(new ImageIcon(getClass().getResource("/flags/2.png")));
							Help.this.jTextPane.setText(" ");
						}
					}
				}
