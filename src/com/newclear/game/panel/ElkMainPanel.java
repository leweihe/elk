...
<<<<<<< .mine
    public ElkMainPanel() {
        ...
        this.p11 = new Point(0, 0);
        this.p22 = new Point(0, 0);
...
=======
    private void initialize() {
        ...
        p11 = new Point(0, 0);
        p22 = new Point(0, 0);
        array = this.f.generateRandomArray();
    }
>>>>>>> .theirs
...
<<<<<<< .mine
    private void drawSelectedBox(Graphics g) throws ClickOutOfBoardException {
        if (this.f.hasSolution()) {
            Graphics2D g2d = (Graphics2D) g;
            g2d.setPaint(Color.red);
            g2d.drawRect(f.getP11().x * 50 + 50, f.getP11().y * 50 + 50, 48, 48);
...
<<<<<<< .mine
    public void doIt(MouseEvent e) throws ClickOutOfBoardException {
        this.f.setP1(new Point(this.f.transferPoint(e.getX(), e.getY())));
        repaint();
        if (((this.p1.x == 0 ? 1 : 0) & (this.p1.y == 0 ? 1 : 0)) != 0) {
            this.p1 = this.f.transferPoint(e.getX(), e.getY());
        } else {
            this.p2 = this.p1;
            this.p1 = this.f.transferPoint(e.getX(), e.getY());
            if ((this.p1.x >= 0) && (this.p1.x <= this.f.getSize()))
